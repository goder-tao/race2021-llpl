...
public class LLPLTest {
    ...
    public void write_hello_string (byte[] input, Heap h, int size)
    {
        ...
        System.out.println("block handle: "+newBlock.handle());
    ...
    public String read_hello_string(Heap h, int size)
    {
        ...
        System.out.println("MBlock size: "+newBlock.size() + ", defined size: "+size);
    ...
    public void main0 () {
        ...
        MemoryBlock memoryBlock = h.memoryBlockFromHandle(4203392);
        System.out.println(memoryBlock.size());
